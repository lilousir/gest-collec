                                        ...
                                        <div class="row medias">
                                            <?php foreach ($medias as $media): ?>
                                                <div class="col-4 col-md-2 mb-4 d-flex align-items-center position-relative media" data-id="<?= $media['id']; ?>">
                                                    ...
                                                    <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-warning <?= ($media['id'] == $item['id_default_img']) ? '' : 'd-none'; ?>" style="z-index: 10; margin-left: 10px; margin-top: 10px;">

    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#tableLicenses').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    sortable : false,
                    render : function(data) {
                        return `<a class="swal2-license-update" id="${data}"
                        href="${baseUrl}/admin/item/updatelicense/${data}"><i class="fa-solid fa-pencil
                        text-success"></i></a>`;
                    }
                },
                {
                    ...
                    sortable : false,
                    render : function(data) {
                        return `<a class="swal2-license" id="${data}" href="${baseUrl}/admin/item/deletelicense/${data}"><i class="fa-solid fa-trash text-danger"></i></a>`;
                    }
                }
            ]
        });
        $("body").on('click', '.swal2-license', function(event) {
            ...
            if (id == 1) {
                ...
                $.ajax({
                    type: "GET",
                    url: baseUrl + "admin/item/totalitembylicense",
                    data: {
                        id: id,
                    },
